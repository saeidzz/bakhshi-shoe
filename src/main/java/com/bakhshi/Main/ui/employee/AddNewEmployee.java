...
public class AddNewEmployee {
	...
	public AddNewEmployee()throws ParseException {
		initialize();
	}
...
;
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (name.equals("") || melliCode.equals("") || year.equals("")
						|| month.equals("") || day.equals("")
						|| phone.equals("") || salery.equals("")
					...
					MyDate date = new MyDate(Integer.parseInt(year.trim()),
							Integer.parseInt(month.trim()), Integer
									.parseInt(day.trim()));
					...
					Employee employee = new Employee(name, melliCode, phone,
							date, Double.parseDouble(sal.trim()), Double
									.parseDouble(adv.trim()),
							cardNumber);

					long res = EmployeeDao.ExistEmployee(employee);
					if (res != -1) {
						JOptionPane.showMessageDialog(frame,
								"این کارگر قبلا اضافه شده است !!");
					} else {
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(nameF, GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_6, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(melliCodeF, GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
								.addGroup(gl_panel.createSequentialGroup()
									.addComponent(yearF)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(monthF, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(dayF, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE))
								.addComponent(phoneNumberF, GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE))
							.addGap(18)
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_panel.createSequentialGroup()
						...
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addComponent(cardNumberF, GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
								.addComponent(advancedMoneyF, GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
								.addComponent(saleryF, GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE))
							.addGap(18)
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
