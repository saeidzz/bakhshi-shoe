package com.bakhshi.Main.ui.dailyProduct;
...
public class EditProduction {
	private JFrame frame;
	private JTextField ProductorNameF;
	...
	public EditProduction(Production production) {
	 ...
	 */
	private void initialize(final Production production) {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(EditProduction.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		...
		JLabel label_6 = new JLabel("نام تولید کننده :");
		label_6.setFont(new Font("Tahoma", Font.BOLD, 15));
		
		JButton saveBtn = new JButton("ذخیره");
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String productorName=ProductorNameF.getText();
				...
				if (productorName.equals("")||size.equals("")||number.equals("")||code.equals("")||year.equals("")||month.equals("")||day.equals("")) {
					JOptionPane.showMessageDialog(frame, "تمام رکورد ها باید مقدار داشته باشند !!");
				    ...
				    Production production1=new Production(code,Integer.parseInt(number),productorName,size,date);
				    production1.setId(production.getId());
				    ProductionfDao.create(production1);
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(ProductorNameF, GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_6, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(sizeF, GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
							.addGap(18)
						...
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(numberf, GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(codef, GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)))
					.addGap(198))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(195)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
					.addGap(402))
		);
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(ProductorNameF, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(12)
		...
		frame.setBounds(100, 100, 559, 623);
