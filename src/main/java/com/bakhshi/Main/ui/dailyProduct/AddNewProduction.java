...
public class AddNewProduction {
	...
	private void initialize() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				GroupLayout.PREFERRED_SIZE, 560, Short.MAX_VALUE));
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (productorName.equals("") || size.equals("")
						|| number.equals("") || code.equals("")
						|| year.equals("") || month.equals("")
						|| day.equals("")) {
					JOptionPane.showMessageDialog(frame,
							"تمام رکورد ها باید مقدار داشته باشند !!");
					...
					Production production = new Production(code, Integer
							.parseInt(number), productorName, size, date);
					ProductionfDao.create(production);
