...
public class PrintShoeSoles {
	...
	public PrintShoeSoles(List<StoredShoeSole> shoeSoles) {
	...
	private void initialize(final List<StoredShoeSole> shoeSoles) {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				PrintShoeSoles.class
						.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		frame.setBounds(100, 100, 796, 881);
		...
		JLabel label = new JLabel("زیره های موجود در انبار");
		label.setFont(new Font("Tahoma", Font.BOLD, 24));
		label.setBackground(Color.WHITE);

		String[] columns = new String[] { "رنگ", "تعداد موجودی", "اندازه",
				"کد زیره", "شماره ", "ردیف" };
		Object[][] data = new Object[shoeSoles.size()][6];

		int i = 0;
		for (StoredShoeSole shoeSole : shoeSoles) {
			data[i] = new Object[] { shoeSole.getColor(), shoeSole.getNumber(),
		...
		JLabel label_12 = new JLabel(
				"آدرس دفتر مرکزی :تهران -منطقه 17 - خیابان سجاد جنوبی -نرسیده به میدان بهاران -پلاک 40 -فروشگاه بخشی");
