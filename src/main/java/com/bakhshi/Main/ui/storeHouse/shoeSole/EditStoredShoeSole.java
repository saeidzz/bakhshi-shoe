...
public class EditStoredShoeSole {
	...
	public EditStoredShoeSole(StoredShoeSole shoeSole) {
		initialize(shoeSole);
	}
	 ...
	 */
	private void initialize(final StoredShoeSole shoeSolein) {
		frame = new JFrame();
		...
		colorF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		colorF.setColumns(10);
		colorF.setText(shoeSolein.getColor());

		JLabel label_5 = new JLabel("رنگ :");
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
              String ShoeSoleNumber=numberF.getText().trim();
              String code=codef.getText();
              String color=colorF.getText();
              String size=sizeF.getText();
              
              
              if(ShoeSoleNumber.equals("")||code.equals("")||color.equals("")||size.equals("")){
            	  JOptionPane.showMessageDialog(frame,
							"تمام ورودی ها باید مقدار داشته باشند!!!!");
              }else{
            	  StoredShoeSole shoeSole=new StoredShoeSole(code,size,Integer.parseInt(ShoeSoleNumber),color);
            	  shoeSole.setId(shoeSolein.getId());
		...
		sizeF.setColumns(10);
		sizeF.setText(shoeSolein.getSize());
		
		JLabel label_1 = new JLabel("سایز :");
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(sizeF, GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(numberF, GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
									.addComponent(colorF, GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
									.addComponent(codef, GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE))
								.addGap(18)
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(192)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE)
					.addGap(405))
		);
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(colorF, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
