...
public class EditStoredShoeSoleTransaction {
	...
	private StoredShoeSole shoeSole;

	public EditStoredShoeSoleTransaction(StoredShoeSoleTransaction shoeSoleTransaction) {
		initialize(shoeSoleTransaction);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(final StoredShoeSoleTransaction storedshoeSoleTransaction) {
		frame = new JFrame();
		...
		shoeSole=storedshoeSoleTransaction.getStoredShoeSole();
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (number == 0 || year == 0
					...
					StoredShoeSoleTransaction storedShoeSoleTransaction1=new StoredShoeSoleTransaction(shoeSole,date,comboBox.getSelectedItem()+"",number);
					storedShoeSoleTransaction1.setId(storedshoeSoleTransaction.getId());
					
				    StoredShoeSoleTransactionDao.create(storedShoeSoleTransaction1);
