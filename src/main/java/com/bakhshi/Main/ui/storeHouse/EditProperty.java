...
public class EditProperty {
	 ...
	 */
	private void initialize(final Property propertyin) {
		frame = new JFrame();
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(panel, GroupLayout.PREFERRED_SIZE, 663, Short.MAX_VALUE)
					.addGap(2))
		);
		...
		NumberF.setText(propertyin.getNumber() + "");

		JLabel label_5 = new JLabel("تعداد :");
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
              ...
              if(proppertyNAme.equals("")){
            	  JOptionPane.showMessageDialog(frame,
							"عنوان کالا نباید خالی باشد!!");
              }else{
            	  Property property=new Property(proppertyNAme,propNumber);
            	  property.setId(propertyin.getId());
		...
		propertyNameF.setText(propertyin.getTitle());
