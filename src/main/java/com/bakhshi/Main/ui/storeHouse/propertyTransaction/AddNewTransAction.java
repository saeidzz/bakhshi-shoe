...
public class AddNewTransAction {
	...
	public AddNewTransAction(Property property) {
		initialize(property);
	}
	 ...
	 */
	private void initialize(final Property property) {
		frame = new JFrame();
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (proppertyNAme.equals("") || propNumber == 0 || year == 0
					...
					PropertyTransactionDao.create(propertyTransaction);
		...
		propertyNameF.setText(property.getTitle());
