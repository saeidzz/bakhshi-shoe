package com.bakhshi.Main.ui.storeHouse;
...
import com.bakhshi.Main.ui.storeHouse.propertyTransaction.Transactions;
...
public class Properties {
	...
	private void initialize(final List<Property> properties) {
		frame = new JFrame();
		...
		String[] columnNames = new String[] { " موجودی ", "نام کالا ",
				" شماره  ", " ردیف " };

		data = new Object[properties.size()][4];

		int i = 0;
		for (Property property : properties) {
			data[i] = new Object[] {
			property.getNumber(), property.getTitle(), property.getId(), i };
			i++;
		}
		...
		JButton btnNewButton = new JButton("حذف کالای انتخاب شده");
		btnNewButton.setBackground(Color.WHITE);
		btnNewButton.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (properties.get(selectedRow) != null) {
					ProPertyDao.delete(properties.get(selectedRow).getId());
					frame.dispose();
		...
		JButton button = new JButton("اضافه کردن کالای جدید");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (properties.get(selectedRow) != null) {
					...
					new EditProperty(properties.get(selectedRow));
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(frame, "لطفا یک سطر را انتخاب نمایید !!");
		...
		showTransActionButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (properties.get(selectedRow) != null) {
					...
					new Transactions(PropertyTransactionDao
							.findByProperty(properties.get(selectedRow)),
							properties.get(selectedRow));
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(frame, "لطفا یک سطر را انتخاب نمایید !!");
		...
		gl_panel_1.setHorizontalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addComponent(button, GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(button_1, GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(showTransActionButton, GroupLayout.PREFERRED_SIZE, 170, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(button_2, GroupLayout.PREFERRED_SIZE, 63, Short.MAX_VALUE)
					.addContainerGap())
		);
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE, false)
							...
							.addComponent(showTransActionButton, GroupLayout.PREFERRED_SIZE, 68, GroupLayout.PREFERRED_SIZE))
