...
public class AddNewEVAFactor {
	...
	public AddNewEVAFactor(List<Customer> customers) {
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (model.equals("")||day.equals("")||month.equals("")||
					...
					EVASaleFactor evaSaleFactor=new EVASaleFactor(c, model, Double.parseDouble(EvaUnitPrie),Double.parseDouble(EvNumber), date,size);
			        EvaFactorDao.create(evaSaleFactor);
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(179)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
					.addGap(418))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(165)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(sizef, GroupLayout.PREFERRED_SIZE, 297, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(label, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(yearF, GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
								.addGap(10)
							...
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(EvaNumber, GroupLayout.DEFAULT_SIZE, 297, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(EvaUnitPrice, GroupLayout.DEFAULT_SIZE, 297, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
									.addComponent(customerCombo, 0, 297, Short.MAX_VALUE)
									.addComponent(EvaModelField, GroupLayout.DEFAULT_SIZE, 297, Short.MAX_VALUE))
								.addGap(18)
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
