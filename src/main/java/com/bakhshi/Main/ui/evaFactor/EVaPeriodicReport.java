...
public class EVaPeriodicReport {
	...
	public EVaPeriodicReport(List<Customer> customers) {
	...
	private void initialize(final List<Customer> customers) {
		...
		monthlyReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(customerCombo.getSelectedIndex()==0){
					new EVAFactors(EvaFactorDao.getByCustomerNameAndMonthDate(date));
					frame.dispose();
				}else{
					new EVAFactors(EvaFactorDao.getByCustomerNameAndMonthDate(customers.get(customerCombo.getSelectedIndex()-1), date));
					frame.dispose();
				}
		...
		annulReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 date=new MyDate(Integer.parseInt(yearF.getText().trim()),Integer.parseInt(monthF.getText().trim()),1);
				if(customerCombo.getSelectedIndex()==0){
					new EVAFactors(EvaFactorDao.getByCustomerNameAndYearDate(date));
					frame.dispose();	
				}else{
					new EVAFactors(EvaFactorDao.getByCustomerNameAndYearDate(customers.get(customerCombo.getSelectedIndex()-1), date));
					frame.dispose();
				}
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(customerCombo.getSelectedIndex()==0){
					new EVaprintFactor(new Customer("همه مشتری ها","نامشخص","نامشخص"),EvaFactorDao.getByCustomerNameAndYearDate(date));
					frame.dispose();
				}else{
					new EVaprintFactor(customers.get(customerCombo.getSelectedIndex()),EvaFactorDao.getByCustomerNameAndYearDate(customers.get(customerCombo.getSelectedIndex()-1), date));
					frame.dispose();
				}
		...
		dailyReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 if(customerCombo.getSelectedIndex()==0){
					 new EVAFactors(EvaFactorDao.getByCustomerNameAndDayDate(date));
						frame.dispose();
				 }else{
					 new EVAFactors(EvaFactorDao.getByCustomerNameAndDayDate(customers.get(customerCombo.getSelectedIndex()-1), date));
						frame.dispose();
				 }
		...
		printDailyReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 date=new MyDate(Integer.parseInt(yearF.getText().trim()),Integer.parseInt(monthF.getText().trim()),Integer.parseInt(dayF.getText()));
					...
					if(customerCombo.getSelectedIndex()==0){
						new EVaprintFactor(new Customer("همه مشتری ها","نامشخص","نامشخص"),EvaFactorDao.getByCustomerNameAndDayDate(date));
			               frame.dispose();
					}else{
						new EVaprintFactor(customers.get(customerCombo.getSelectedIndex()),EvaFactorDao.getByCustomerNameAndDayDate(customers.get(customerCombo.getSelectedIndex()-1),date));
			               frame.dispose();
					}
			}
		});
