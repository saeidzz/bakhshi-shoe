...
public class EditPVCFactor {
	 ...
	 */
	public EditPVCFactor(PVCSaleFactor pvcSaleFactor) {
		initialize(pvcSaleFactor);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(final PVCSaleFactor pvcSaleFactor) {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(AddNewPVCFactor.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pvcNumber=EvaNumber.getText().trim();
				String pvcUnitPrie=EvaUnitPrice.getText().trim();
				Customer c=customers.get(customerCombo.getSelectedIndex());
				String size=sizef.getText();
				
				if (model.equals("")||day.equals("")||month.equals("")||
						year.equals("")||pvcNumber.equals("")||pvcUnitPrie.equals("")||c==null) {
					...
					PVCSaleFactor pvcSaleFactor1=new PVCSaleFactor(c,date,model,Double.parseDouble(pvcUnitPrie.trim()),Integer.parseInt(pvcNumber.trim()),size);
			        pvcSaleFactor1.setId(pvcSaleFactor.getId());
					PvcFactorDao.create(pvcSaleFactor1);
		...
		sizef.setColumns(10);
		sizef.setText(pvcSaleFactor.getSize());
				...
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
							.addComponent(yearF, GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE)
							.addGap(10)
						...
						.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
							.addComponent(EvaNumber, GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addComponent(customerCombo, 0, 271, Short.MAX_VALUE)
								.addComponent(EvaModelField, GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE))
							.addGap(18)
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addComponent(sizef, GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
								.addComponent(EvaUnitPrice, GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE))
							.addGap(18)
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
