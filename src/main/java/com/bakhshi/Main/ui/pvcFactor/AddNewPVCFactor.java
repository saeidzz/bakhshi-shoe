...
public class AddNewPVCFactor {
	...
	public AddNewPVCFactor(List<Customer> customers) {
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(177)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 233, Short.MAX_VALUE)
					.addGap(420))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(165)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(sizef, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(yearF, GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE)
								.addGap(10)
							...
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(EvaNumber, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(EvaUnitPrice, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
									.addComponent(customerCombo, 0, 287, Short.MAX_VALUE)
									.addComponent(EvaModelField, GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE))
								.addGap(18)
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
