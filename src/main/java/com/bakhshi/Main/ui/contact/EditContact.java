package com.bakhshi.Main.ui.contact;
...
public class EditContact {
	 ...
	 */
	private void initialize(final Contact contact) {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(EditContact.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(panel, GroupLayout.PREFERRED_SIZE, 560, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		phoneNumberF.setText(contact.getPhoneNumber());
		...
		addressTextArea.setFont(new Font("B Nazanin", Font.BOLD, 18));
		addressTextArea.setBackground(Color.WHITE);
		addressTextArea.setBorder(phoneNumberF.getBorder());
		addressTextArea.setTabSize(4);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(name.equals("")||address.equals("")||phone.equals("")){
					...
					Contact contactI=new Contact(name, address, phone);
					contactI.setId(contact.getId());
					ContactDao.create(contactI);
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_panel.createSequentialGroup()
									.addComponent(phoneNumberF, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
									.addGap(18)
									.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panel.createSequentialGroup()
									.addComponent(nameF, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
									.addGap(18)
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(addressTextArea, GroupLayout.PREFERRED_SIZE, 194, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
		...
		frame.setBounds(100, 100, 596, 565);
