...
public class EditAbsent {
	...
	public EditAbsent(Absent absent) {
		initialize(absent);
	}
	 ...
	 */
	private void initialize(final Absent absent) {

		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				EditAbsent.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		...
		dayF.setColumns(10);
		nameF.setText(absent.getEmployee().getName());
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (day.equals("") || month.equals("") || year.equals("")) {
					...
					if (res != -1) {
						...
						Absent absent1 = new Absent(date, absent.getEmployee());
						absent1.setId(absent.getId());
						AbsentDao.create(absent1);
						new Absents(AbsentDao.findByEmployeeIdId(absent.getEmployee()),absent.getEmployee());
						frame.dispose();
		...
		yearF.setColumns(10);
		yearF.setText(absent.getAbsentDate().getYear() + "");
		monthF.setText(absent.getAbsentDate().getMonth() + "");
		dayF.setText(absent.getAbsentDate().getDay() + "");
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addComponent(nameF, GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(yearF, GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(monthF, GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(dayF, GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)))
					.addGap(53)
		...
		frame.setBounds(100, 100, 661, 565);
