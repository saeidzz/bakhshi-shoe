package com.bakhshi.Main.ui.AbsentEmployee;
...
public class Absents {
	 ...
	 */
	public Absents(List<Absent>  absents,Employee employee) {
		initialize(absents,employee);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(final List<Absent>  absents,final Employee employee) {
		
		
		frame = new JFrame();
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				Absents.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		frame.getContentPane().setBackground(Color.WHITE);
		frame.setVisible(true);
		

		String[] columnNames = new String[] { "تاریخ غیبت ","شماره","ردیف"};

		
		data = new Object[absents.size()][3];

		int i = 0;
		for (Absent absent : absents) {
			data[i] = new Object[] { absent.getAbsentDate().toString(),absent.getId(),i };
			i++;
		}
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup()
					.addGap(110)
					.addComponent(employeeCostractDate, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
					.addGap(70)
					.addComponent(employeeMelliCode, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
					.addGap(78)
					.addComponent(employeeName, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
					.addGap(34))
		);
			...
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
						.addComponent(employeeMelliCode, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
						.addComponent(employeeCostractDate, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
						.addComponent(employeeName, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 891, Short.MAX_VALUE)
		...
		JButton btnNewButton = new JButton("حذف غیبت انتخاب شده");
		btnNewButton.setBackground(Color.WHITE);
		btnNewButton.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(absents.get(selectedRow)!=null){
				AbsentDao.delete(absents.get(selectedRow).getId());
				frame.dispose();
				new Absents(AbsentDao.findByEmployeeIdId(employee), employee);
				}else{
					JOptionPane.showMessageDialog(frame, "لطفا یک غیبت را انتخاب نمایید !!");
				}
				
			}
		});

		JButton button = new JButton("اضافه کردن غیبت برای این کارگر");
		button.setBackground(Color.WHITE);
		button.setFont(new Font("Tahoma", Font.BOLD, 15));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new AddNewAbsent(employee);
				 frame.dispose();
               
			}
		});

		JButton button_1 = new JButton("به روز رسانی غیبت انتخاب شده");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (absents.get(selectedRow)!=null){
					new EditAbsent(absents.get(selectedRow));
					frame .dispose();
				}else{
					JOptionPane.showMessageDialog(frame, "لطفا یک غیبت را انتخاب نمایید !!");
				}
		...
		gl_panel_1.setHorizontalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(button, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
					.addGap(18)
					.addComponent(button_1, GroupLayout.PREFERRED_SIZE, 225, Short.MAX_VALUE)
					.addGap(18))
		);
