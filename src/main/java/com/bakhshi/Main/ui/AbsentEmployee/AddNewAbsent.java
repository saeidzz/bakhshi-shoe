...
public class AddNewAbsent {
	...
	public AddNewAbsent(Employee employee) {
		initialize(employee);
	}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (day.equals("") || month.equals("") || year.equals("")) {
					...
					if (res != -1) {
						...
						Absent absent = new Absent(date,employee);
						AbsentDao.create(absent);
						new Absents(AbsentDao.findByEmployeeIdId(employee),
								employee);
						frame.dispose();
