	...
	private void initialize(final Customer customer) {
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addComponent(panel, GroupLayout.DEFAULT_SIZE, 452,
		...
		phoneNumberF.setText(customer.getPhoneNumber());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (name.equals("") || phone.equals("") || address.equals("")) {
					...
					Customer cusstomer = new Customer(name, address, phone);
					cusstomer.setId(customer.getId());
					CustomerDao.create(cusstomer);
