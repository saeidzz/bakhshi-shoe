	...
	private void initialize() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(panel, GroupLayout.PREFERRED_SIZE, 530, Short.MAX_VALUE)
		);
		...
		addressTextArea.setBackground(SystemColor.menu);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (name.equals("") || phone.equals("") || address.equals("")) {
					...
					long res = CustomerDao.ExistCustomer(customer);
					if (res != -1) {
						JOptionPane.showMessageDialog(frame,
								"این مشتری را قبلا ذخیره کرده اید !!");
					} else {
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(phoneNumberF, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(nameF, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_6, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(addressTextArea, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
							.addGap(18)
