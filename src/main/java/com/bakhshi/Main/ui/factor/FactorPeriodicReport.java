...
public class FactorPeriodicReport {
	...
	public FactorPeriodicReport(List<Customer> customers) {
	...
	private void initialize(final List<Customer> customers) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 523,
								Short.MAX_VALUE).addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				Alignment.LEADING).addGroup(
				groupLayout
						.createSequentialGroup()
						.addComponent(panel, GroupLayout.DEFAULT_SIZE, 497,
		...
		monthlyReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MyDate date = new MyDate(Integer.parseInt(yearF.getText()
						.trim()), Integer.parseInt(monthF.getText().trim()), 1);

				new Factors(SaleFactorDao.getByCustomerNameAndMonthDate(
						customers.get(customerCombo.getSelectedIndex()), date));
				frame.dispose();
		...
		annulReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new Factors(SaleFactorDao.getByCustomerNameAndYearDate(
						customers.get(customerCombo.getSelectedIndex()), date));
				frame.dispose();
			}
		});
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				new printFactor(
						customers.get(customerCombo.getSelectedIndex()),
						SaleFactorDao.getByCustomerNameAndYearDate(
								customers.get(customerCombo.getSelectedIndex()),
								date));
				frame.dispose();
			}
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				new printFactor(
						customers.get(customerCombo.getSelectedIndex()),
						SaleFactorDao.getByCustomerNameAndMonthDate(
								customers.get(customerCombo.getSelectedIndex()),
								date));
				frame.dispose();
			}
