...
public class AddNewFactor {
	...
	public AddNewFactor(List<Customer> customers) {
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (model.equals("") || day.equals("") || month.equals("")
					...
					SaleFactor saleFactor=new SaleFactor(c,name,date,Double.parseDouble(UnitPrie),Integer.parseInt(Number),size,model);
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(modelF, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(sizeF, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(yearF, GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
							.addGap(10)
						...
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(numberField, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(unitPriceField, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
								.addComponent(customerCombo, 0, 220, Short.MAX_VALUE)
								.addComponent(nameF, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE))
							.addGap(18)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(188)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
					.addGap(409))
		);
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(numberField, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(12)
							.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)))
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(unitPriceField, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(12)
					...
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(modelF, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
