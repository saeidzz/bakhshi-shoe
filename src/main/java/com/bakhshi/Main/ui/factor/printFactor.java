...
public class printFactor {
	...
	public printFactor(Customer customer, List<SaleFactor> factors) {
	 ...
	 */
	private void initialize(final Customer customer,
			final List<SaleFactor> factors) {
		frame = new JFrame();
		frame.setResizable(false);
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				PVCprintFactor.class
		...
		String[] columns = new String[] { "قیمت کل", "فی", "تعدداد","نام کالا","اندازه",
				"نوع کالا", "شماره فاکتور", "ردیف" };
		Object[][] data = new Object[factors.size()][7];

		int i = 0;
		double total = 0;
		for (SaleFactor factor : factors) {
			data[i] = new Object[] {
					String.format("%,.0f", factor.getWholePrice()),
					String.format("%,.0f", factor.getUnitPrice()),
					String.format("%.0f", factor.getNumber()),factor.getProductName(),
					factor.getSize(), factor.getModel(), factor.getId(),
					i
		...
		totalPrice.setFont(new Font("B Nazanin", Font.BOLD, 19));
		...
		JLabel lblNewLabel = new JLabel(new ImageIcon(
				Container.class.getResource("icon30.jpg")));

		JLabel lblNewLabel_1 = new JLabel(
				"آدرس :سه راه آدران-شهرک قلعه میر-بعد از آتش نشانی - خیابان شهید مفتح-خیبان درختی سمت راست-اولین کارخانه سمت چپ-پلاک 1");
		lblNewLabel_1.setFont(new Font("B Nazanin", Font.BOLD, 16));

		JLabel label_11 = new JLabel(
				"تلفن :56863214                فکس :56860589");
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_1.createSequentialGroup()
							...
							.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel_1.createSequentialGroup()
									.addComponent(label_2, GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
									.addGap(161))
								.addGroup(gl_panel_1.createSequentialGroup()
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel_1.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 779, GroupLayout.PREFERRED_SIZE))
						.addGroup(Alignment.LEADING, gl_panel_1.createSequentialGroup()
							...
							.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
								...
								.addComponent(label_12, GroupLayout.PREFERRED_SIZE, 632, GroupLayout.PREFERRED_SIZE))))
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (factors.get(selectedRow) != null) {
					...
					new printFactor(customer, factors);
					frame.dispose();
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(167))
				.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 790, Short.MAX_VALUE)
		);
