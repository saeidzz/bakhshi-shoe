	...
	private void initialize() {
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Capsul capsul = new Capsul(code, size, Integer.parseInt(number));
		...
		gl_panel.setHorizontalGroup(gl_panel
				...
				.addGroup(
						gl_panel.createSequentialGroup()
								.addGap(162)
								.addComponent(codeF, GroupLayout.DEFAULT_SIZE,
										206, Short.MAX_VALUE)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(label_2,
										GroupLayout.PREFERRED_SIZE, 162,
										GroupLayout.PREFERRED_SIZE).addGap(201))
				.addGroup(
						Alignment.LEADING,
						gl_panel.createSequentialGroup()
								.addGap(184)
				...
				.addGroup(
						gl_panel.createSequentialGroup()
								...
								.addComponent(saveBtn,
										...
										GroupLayout.PREFERRED_SIZE).addGap(240)));
