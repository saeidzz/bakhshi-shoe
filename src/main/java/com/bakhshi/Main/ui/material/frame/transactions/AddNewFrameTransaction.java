...
public class AddNewFrameTransaction {
	...
	public AddNewFrameTransaction(Frame frame, String IorO) {
		initialize(frame, IorO);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(final Frame inframe, final String iORo) {
		frame = new JFrame();
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				FrameDao.create(inframe);
				FrameTransAction transAction = new FrameTransAction(date,
						inframe, number, inOrOutv);
				FrameTransactionsDao.create(transAction);
				
				new FrameTransactions(FrameTransactionsDao.read(iORo, inframe),
						inframe, iORo);
				frame.dispose();
			}
		});
		...
		frameCode.setText(inframe.getCode());
