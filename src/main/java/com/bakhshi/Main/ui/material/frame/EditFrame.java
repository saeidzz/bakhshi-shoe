...
public class EditFrame {
	 ...
	 */
	private void initialize(final Frame framee) {
		frame = new JFrame();
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String productord = (String)comboBox.getSelectedItem();
				String number = numberF.getText().trim();
				String size = sizeF.getText();
				String code = frameCode.getText();

				Frame framee1 = new Frame(code, size, productord, Integer
						.parseInt(number));
				framee1.setId(framee.getId());
				FrameDao.create(framee1);
		...
		frameCode.setText(framee.getCode());
		...
		comboBox.addItem("خارجی");
		comboBox.addItem("ایرانی");
				...
				.addGroup(
						gl_panel.createSequentialGroup()
								...
								.addComponent(saveBtn,
										...
										GroupLayout.PREFERRED_SIZE).addGap(344)));
