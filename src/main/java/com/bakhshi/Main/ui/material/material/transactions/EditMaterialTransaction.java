package com.bakhshi.Main.ui.material.material.transactions;
...
import com.bakhshi.Main.data_access.MaterialTransactionDao;
...
import com.bakhshi.Main.ui.material.capsul.AddNewCapsul;
...
public class EditMaterialTransaction {

	private JFrame frame;
	private JTextField materialTypeF;
	private JTextField materialCodeF;
	private JTextField wholeWiegthF;
	private JTextField numberF;
	private JTextField inputOutputF;
	private JTextField byF;
	private JTextField yearF;
	private JTextField monthF;
	private JTextField dayF;

	public EditMaterialTransaction(MatrialTransaction transaction) {
	 ...
	 */
	private void initialize(final MatrialTransaction transaction) {
		frame = new JFrame();
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 574,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						.createSequentialGroup()
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 486,
								Short.MAX_VALUE).addContainerGap()));
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double wholeWeight = Double.parseDouble(wholeWiegthF.getText()
						.trim());
				...
				String inOout = inputOutputF.getText();
				...
				if (inOout.equals("ورودی")) {
					int n = transaction.getMaterial().getNumber();
					double w = transaction.getMaterial().getWeight();
					n += number;
					w += wholeWeight;
					transaction.getMaterial().setWeight(w);
					transaction.getMaterial().setNumber(n);
				} else if (inOout.equals("خروجی")) {
					int n = transaction.getMaterial().getNumber();
					double w = transaction.getMaterial().getWeight();
					n -= number;
					w -= wholeWeight;
				...
				MaterialDao.create(transaction.getMaterial());
				MatrialTransaction transactions = new MatrialTransaction(
						transaction.getMaterial(), date, number, wholeWeight, by, inOout);
				transactions.setId(transaction.getId());
				MaterialTransactionDao.create(transactions);
				new MaterialTransactions(MaterialTransactionDao.read(transaction.getInputOrOutput(),
						transaction.getMaterial()), transaction.getInputOrOutput(), transaction.getMaterial());
		...
		materialTypeF = new JTextField();
		materialTypeF.setEditable(false);
		materialTypeF.setFont(new Font("Arial", Font.BOLD, 18));
		materialTypeF.setColumns(10);
		materialTypeF.setText(transaction.getMaterial().getType());

		JLabel label = new JLabel("نوع مواد :");
		label.setFont(new Font("Tahoma", Font.BOLD, 15));

		materialCodeF = new JTextField();
		materialCodeF.setEditable(false);
		materialCodeF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		materialCodeF.setColumns(10);
		materialCodeF.setText(transaction.getMaterial().getCode());

		JLabel label_1 = new JLabel("کد مواد :");
		label_1.setFont(new Font("Tahoma", Font.BOLD, 15));

		wholeWiegthF = new JTextField();
		wholeWiegthF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		wholeWiegthF.setColumns(10);
		wholeWiegthF.setText(transaction.getWeight()+"");

		numberF = new JTextField();
		numberF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		numberF.setColumns(10);
		numberF.setText(transaction.getNumber()+"");

		JLabel label_6 = new JLabel("تعداد :");
		label_6.setFont(new Font("Tahoma", Font.BOLD, 15));

		inputOutputF = new JTextField();
		inputOutputF.setEditable(false);
		inputOutputF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		inputOutputF.setColumns(10);
		inputOutputF.setText(transaction.getInputOrOutput());

		JLabel label_3 = new JLabel("ورودی یا خروجی :");
		label_3.setFont(new Font("Tahoma", Font.BOLD, 15));

		JLabel label_4 = new JLabel("وزن  :");
		label_4.setFont(new Font("Tahoma", Font.BOLD, 15));

		byF = new JTextField();
		byF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		byF.setColumns(10);
		byF.setText(transaction.getBy());
