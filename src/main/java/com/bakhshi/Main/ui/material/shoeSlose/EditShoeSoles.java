...
public class EditShoeSoles {
	...
	private JTextField factorNumberField;

	
	public EditShoeSoles( ShoeSoles soles) {
		initialize(soles);
	}
	 ...
	 */
	private void initialize(final ShoeSoles soles) {
		frame = new JFrame();
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                String factorNumb=factorNumberField.getText();
				...
				ShoeSoles shoeSoles = new ShoeSoles(date, code, size, number,
						unitP, byf,factorNumb);
				shoeSoles.setId(soles.getId());
		...
		by.setText(soles.getSavedBy());
		by.setColumns(10);
		
		factorNumberField = new JTextField();
		factorNumberField.setText((String) null);
		factorNumberField.setFont(new Font("B Nazanin", Font.BOLD, 18));
		factorNumberField.setColumns(10);
		factorNumberField.setText(soles.getFactorNumber());
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(192)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
					.addGap(405))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(165)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(factorNumberField, GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_6, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(by, GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup()
								.addComponent(codeF, GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(yearF, GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
								.addGap(10)
							...
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(numberF, GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_3, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(unitPrice, GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
								.addGap(18)
								.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_panel.createSequentialGroup()
								.addComponent(sizeF, GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
								.addGap(18)
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(unitPrice, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(12)
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(by, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(factorNumberField, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
