package com.bakhshi.Main.ui.material.material;
...
public class EditMaterial {
	...
	private JTextField wholeWiegth;
	 ...
	 */
	private void initialize(final Materials materials) {
		frame = new JFrame();
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				GroupLayout.DEFAULT_SIZE, 687, Short.MAX_VALUE));
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String matkind = (String)materialType.getSelectedItem();
				String code = materialCode.getText();
				String wholeWeight = wholeWiegth.getText().trim();
				String Number = numberF.getText().trim();

				Materials materials1 = new Materials(Integer.parseInt(Number), Double.parseDouble(wholeWeight),code,matkind);
				materials1.setId(materials.getId());
				MaterialDao.create(materials1);
				new com.bakhshi.Main.ui.material.material.MaterialsList(MaterialDao.read());
				frame.dispose();
			}
		});
		...
		materialType = new JComboBox<String>();
		materialType.setEditable(false);
		materialType.setFont(new Font("Arial", Font.BOLD, 18));
		materialType.addItem("PVC");
		materialType.addItem("EVA");

		JLabel label = new JLabel("نوع مواد :");
		label.setFont(new Font("Tahoma", Font.BOLD, 15));

		materialCode = new JTextField();
		materialCode.setFont(new Font("B Nazanin", Font.BOLD, 18));
		materialCode.setText(materials.getCode());
		...
		wholeWiegth = new JTextField();
		wholeWiegth.setFont(new Font("B Nazanin", Font.BOLD, 18));
		wholeWiegth.setText(materials.getWeight() + "");
		wholeWiegth.setColumns(10);
		wholeWiegth.setText(materials.getWeight()+"");

		JLabel label_2 = new JLabel("وزن کل :");
		label_2.setFont(new Font("Tahoma", Font.BOLD, 15));

		numberF = new JTextField();
		numberF.setFont(new Font("B Nazanin", Font.BOLD, 18));
		numberF.setText(materials.getNumber() + "");
				...
				.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(wholeWiegth, GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(numberF, GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_6, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(materialCode, GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(materialType, GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)))
					.addGap(198))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(180)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
					.addGap(417))
		);
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addComponent(materialCode, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(13)
							.addComponent(label_1, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(materialType, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
					...
					.addGap(14)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(wholeWiegth, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE)
