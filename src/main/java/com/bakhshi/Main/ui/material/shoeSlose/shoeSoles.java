...
public class shoeSoles {
	...
	public shoeSoles(List<ShoeSoles> shoeSoles) {
	...
	private void initialize(final List<ShoeSoles> shoeSoles) {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				shoeSoles.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (shoeSoles.get(selectedRow) != null) {
					ShoeSolesDao.delete(shoeSoles.get(selectedRow).getId());
					frame.dispose();
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (shoeSoles.get(selectedRow) != null) {
					frame.dispose();
					new EditShoeSoles(shoeSoles.get(selectedRow));
				} else {
					JOptionPane.showMessageDialog(frame,
							"لطفا یک سطر را انتخاب نمایید !!");
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new PrintShoeSoles(ShoeSolesDao.read());
			}
		});
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(
				...
				gl_panel_1
						...
						.addComponent(btnNewButton, GroupLayout.DEFAULT_SIZE,
								205, Short.MAX_VALUE)
						.addGap(18)
						.addComponent(button, GroupLayout.DEFAULT_SIZE, 203,
								Short.MAX_VALUE)
						.addGap(18)
						.addComponent(button_1, GroupLayout.DEFAULT_SIZE, 265,
								Short.MAX_VALUE)
						.addGap(18)
						.addComponent(button_2, GroupLayout.DEFAULT_SIZE, 77,
