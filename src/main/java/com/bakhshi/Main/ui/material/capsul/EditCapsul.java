...
public class EditCapsul {
	...
	public EditCapsul(Capsul capsul) {
		initialize(capsul);
	}
	 ...
	 */
	private void initialize(final Capsul capsul) {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(AddNewCapsul.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(panel, GroupLayout.DEFAULT_SIZE, 687, Short.MAX_VALUE)
		);
		...
		EvaNumber.setText(capsul.getNumber()+"");
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String number=EvaNumber.getText().trim();
				String size=sizeF.getText();
				String code=codeF.getText();
			
			
			    Capsul capsul1=new Capsul(code,size,Integer.parseInt(number));
			    capsul1.setId(capsul.getId());
			    CapsulDao.create(capsul1);
...
//String selectedBook = (String) comboBox.getSelectedItem();
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(codeF, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(sizeF, GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
							.addGap(18)
							.addComponent(label_5, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(EvaNumber, GroupLayout.DEFAULT_SIZE, 214, Short.MAX_VALUE)
							.addGap(18)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(195)
					.addComponent(saveBtn, GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
					.addGap(402))
		);
