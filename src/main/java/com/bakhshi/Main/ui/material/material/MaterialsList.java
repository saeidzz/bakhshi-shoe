...
import com.bakhshi.Main.ui.material.material.transactions.MaterialTransactions;
...
public class MaterialsList {
	...
	private void initialize(
			final List<com.bakhshi.Main.Model.materials.material.Materials> materials) {

		frame = new JFrame();
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				MaterialsList.class.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		frame.getContentPane().setBackground(Color.WHITE);
		frame.setVisible(true);

		String[] columnNames = new String[] { " کد مواد ", " وزن کل "," تعداد ", " نوع مواد ", " شماره ", " ردیف ", };

		data = new Object[materials.size()][6];

		int i = 0;
		for (com.bakhshi.Main.Model.materials.material.Materials MAT : materials) {
			data[i] = new Object[] { MAT.getCode(), MAT.getWeight(),
					MAT.getNumber(), MAT.getType(), MAT.getId(), i };
			i++;
		}
		...
		panel.getTable().getColumnModel().getColumn(3).setCellRenderer(new SimpleTableCellRender());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (materials.get(selectedRow) != null) {
					MaterialDao.delete(materials.get(selectedRow).getId());
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (materials.get(selectedRow) != null) {
					new EditMaterial(materials.get(selectedRow));
					frame.dispose();
		...
		JButton button_3 = new JButton("نمایش ورودی");
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (materials.get(selectedRow) != null) {
					new MaterialTransactions(MaterialTransactionDao.read(
							"ورودی", materials.get(selectedRow)), "ورودی",
							materials.get(selectedRow));
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(frame, "لطفا یک سطر را انتخاب نمایید !!");
		...
		JButton button_4 = new JButton("نمایش خروجی");
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (materials.get(selectedRow) != null) {
					new MaterialTransactions(MaterialTransactionDao.read(
							"خروجی", materials.get(selectedRow)), "خروجی",
							materials.get(selectedRow));
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(frame, "لطفا یک سطر را انتخاب نمایید !!");
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(
				...
				gl_panel_1
						...
						.addComponent(button_3, GroupLayout.DEFAULT_SIZE, 184,
								Short.MAX_VALUE)
						.addGap(18)
						.addComponent(button_4, GroupLayout.DEFAULT_SIZE, 184,
								Short.MAX_VALUE)
						.addGap(15)
						.addComponent(button, GroupLayout.PREFERRED_SIZE, 142,
								GroupLayout.PREFERRED_SIZE)
						.addGap(18)
						.addComponent(button_1, GroupLayout.PREFERRED_SIZE,
								270, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addComponent(button_2, GroupLayout.DEFAULT_SIZE, 118,
