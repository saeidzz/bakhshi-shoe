...
public class EditCapsulTransaction {
	...
	public EditCapsulTransaction(
			com.bakhshi.Main.Model.materials.capsul.CapsulTransactions capsulTransactions) {
		initialize(capsulTransactions);
	}
	...
	private void initialize(
			final com.bakhshi.Main.Model.materials.capsul.CapsulTransactions capsulTransactions) {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(
				AddNewCapsulTransaction.class
						.getResource("/com/bakhshi/Main/ui/icon.jpg")));
		frame.getContentPane().setBackground(Color.WHITE);
		frame.setVisible(true);

		final Capsul capsul = capsulTransactions.getCapsul();
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 741,
								Short.MAX_VALUE).addGap(1)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
				Alignment.LEADING).addGroup(
				groupLayout
						.createSequentialGroup()
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 488,
		...
		numberf.setText(capsulTransactions.getNumber() + "");
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				com.bakhshi.Main.Model.materials.capsul.CapsulTransactions c = new com.bakhshi.Main.Model.materials.capsul.CapsulTransactions(
						capsul, date, deliver, transrer, inorout, number);
				CapsulTransactionDao.create(c);
				
				new CapsulTransactions(CapsulTransactionDao.read(
						capsulTransactions.getInputOrOutput(), capsul),
						capsulTransactions.getInputOrOutput(), capsul);
				frame.dispose();
			}
		});
		...
		delivery.setText(capsulTransactions.getDelivery());

		transfee = new JTextField();
		transfee.setFont(new Font("B Nazanin", Font.BOLD, 18));
		transfee.setColumns(10);
		transfee.setText(capsulTransactions.getTranferee());
		MyDate d = capsulTransactions.getDate();
		...
		inoroutf.setText(capsulTransactions.getInputOrOutput());
		...
		JLabel label_4 = new JLabel("تحویل دهنده :");
