...
import com.bakhshi.Main.Model.materials.material.*;
...
public class AddNewMaterialTransaction {
	...
	public AddNewMaterialTransaction(com.bakhshi.Main.Model.materials.material.Materials materials, String inOrOut) {
		initialize(materials, inOrOut);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(final com.bakhshi.Main.Model.materials.material.Materials material, final String inOrOut) {
		frame = new JFrame();
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (inOout.equals("ورودی")) {
					int n = material.getNumber();
					double w = material.getWeight();
					n += number;
					w += wholeWeight;
				...
				MatrialTransaction transactions = new MatrialTransaction(
						material, date, number, wholeWeight, by, inOout);
				MaterialTransactionDao.create(transactions);
				new MaterialTransactions(MaterialTransactionDao.read(inOrOut,
						material), inOrOut, material);
		...
		materialTypeF.setText(material.getType());
		...
		materialCodeF.setText(material.getCode());
