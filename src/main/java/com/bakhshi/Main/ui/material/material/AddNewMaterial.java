...
public class AddNewMaterial {
	...
	private JComboBox<String> materialKind;
	...
	private void initialize() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(
				...
				groupLayout
						...
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 672,
		...
		saveBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String matkind = (String)materialKind.getSelectedItem();
				String code = materialCode.getText();
				String wholeWeight = wholeWiegth.getText().trim();
				String Number = numberF.getText().trim();

				Materials materials = new Materials(Integer.parseInt(Number),
						Double.parseDouble(wholeWeight), code, matkind);
				MaterialDao.create(materials);
				
				new com.bakhshi.Main.ui.material.material.MaterialsList(MaterialDao
						.read());
				frame.dispose();
		...
		materialKind = new JComboBox<String>();
		materialKind.setEditable(false);
		materialKind.setFont(new Font("Arial", Font.BOLD, 18));
		materialKind.addItem("PVC");
		materialKind.addItem("EVA");
				...
				.addGroup(
						gl_panel.createSequentialGroup()
								...
								.addComponent(saveBtn,
										...
										GroupLayout.PREFERRED_SIZE).addGap(296)));
